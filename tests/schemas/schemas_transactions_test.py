                          ...
                          {"transaction_id": "txn-004",
                           "receiver_id": "receiver004",
                             ...
                             {"transaction_id": "txn-006",
                              "payer_id": "payer006",
                              "receiver_id": "receiver006",
                              "currency": "BRL"},
                             {"transaction_id": "txn-007",
                              "payer_id": "payer007",
                              "receiver_id": "receiver007",
                              "amount": 120}])
...
@pytest.mark.parametrize("invalid_data",
                         [{"transaction_id": "txn-008",
                           "payer_id": "payer008",
                           "receiver_id": "receiver008",
                           "amount": -10,
                           "currency": "USD"},
                          {"transaction_id": "txn-009",
                           "payer_id": "payer009",
                             "receiver_id": "receiver009",
                             "amount": 0,
                             "currency": "USD"},
                          ])
...
@pytest.mark.parametrize("invalid_data",
                         [{"transaction_id": 123,
                           "payer_id": "payer010",
                           "receiver_id": "receiver010",
                           "amount": 50,
                           "currency": "USD"},
                          {"transaction_id": "txn-011",
                           "payer_id": None,
                             "receiver_id": "receiver011",
                             "amount": 50,
                             "currency": "USD"},
